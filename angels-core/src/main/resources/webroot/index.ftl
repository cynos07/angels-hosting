    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right">
        <ul id="menu_list" class="nav navbar-nav navbar-right">
          <p>            <li class="active"><a href="index">Home</a></li>
    ...
    <div class="row">
      <div class="main-slider">
        <div class="slide-text">
          <h1>커뮤니티형 웹호스팅</h1>
          <p>엔젤 호스팅은 2014년부터 시작한 커뮤니티형 웹호스팅입니다. 호스팅의 시작은 커뮤니티에서 시작되었음을 알리며, 따라서 호스팅 사용료 또한 타호스팅에 비해 저렴하다는 장점이 있습니다. 또한 커뮤니티형 웹호스팅이기 때문에 궁극적인 목표는 금전적인 이득이 아님을 밝힙니다.</p>
        </div>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" class="form-control" id="id" placeholder="Login" autofocus>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input type="password" class="form-control" id="password" placeholder="Password" onkeypress="JavaScript:press(this.form)">
